    ...
    return (
      <Fragment>
        ...
        <section className="example">
          <Row>
            <Col span={24}>
              <Checkbox className="mobile mb20">Default</Checkbox>
            </Col>

            <Col span={24}>
              <Checkbox className="mobile mb20" onChange={this.handleChange} checked={this.state.check}>Selected</Checkbox>
            </Col>

            <Col span={24}>
              <Checkbox className="mobile mb20" disabled>Disabled</Checkbox>
            </Col>

            <Col span={24}>
              <Checkbox className="mobile" disabled checked>Disabled + Selected</Checkbox>
            </Col>
          </Row>
        </section>
