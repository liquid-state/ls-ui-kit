...
class TableRows extends Component {
  render() {
    return (
      <Table className="mobile rows hide" dataSource={dataSource} columns={columns} />
    );
  }

  componentDidMount() {
    const elements = document.querySelectorAll('.ant-table-wrapper.mobile.rows .ant-table-row-level-0');
